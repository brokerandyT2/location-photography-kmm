...
class GetOptimalShootingTimesQueryValidator : IValidator<GetOptimalShootingTimesQuery> {
    ...
    override suspend fun validate(request: GetOptimalShootingTimesQuery): ValidationResult {
