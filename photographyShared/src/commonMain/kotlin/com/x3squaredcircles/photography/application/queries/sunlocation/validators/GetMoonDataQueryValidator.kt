// photographyShared/src/commonMain/kotlin/com/x3squaredcircles/photography/application/queries/sunlocation/validators/GetMoonDataQueryValidator.kt
...
class GetMoonDataQueryValidator : IValidator<GetMoonDataQuery> {
    ...
    override suspend fun validate(request: GetMoonDataQuery): ValidationResult {
